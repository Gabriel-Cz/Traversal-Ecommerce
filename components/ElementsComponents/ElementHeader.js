...
const ElementShape = () => {
    return(
      <div className={styles.elementShape}>
...
function ElementHeader({elementName}) {
    return(
        <>
          <Container fluid className={styles[`${elementName}`]}>
            <ElementShape />
              ...
              <Col xs={10} md={4}>
                  <div className="text-center">
                      <p className={styles.subHeader}>
                         Amazing <i style={{textTransform: "capitalize"}}>{elementName}</i> that gonna make you look <br></br> <span style={{textTransform: "uppercase", borderBottom: "1px ridge #6C1D13", fontWeight: "bold", color: "#6C1D13"}}>Invincible</span> <br></br> whenever you go.
                      </p>
                  </div>
              </Col>
            </Row>
