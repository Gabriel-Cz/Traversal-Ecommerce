...
import ProductInformation from '../../components/ProductPageInformation/ProductInformation'
  ...
  return(
      <>
        <div className="d-flex justify-content-center align-items-center ">
            <SvgTruck></SvgTruck>
            <small className={styles.shipmentInformation}>Shipment in 3 days</small>
        </div>
      </>
  );
}
